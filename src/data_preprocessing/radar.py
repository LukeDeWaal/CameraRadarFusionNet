...
def normalize(channel, value, normalization_interval=(-1, 1), sigma_factor=1):
    ...
    if normalizing_mask[channel]:
        ...
        normalized_value = (normalized_value * (normalization_interval[1] - normalization_interval[0])) + \
                           normalization_interval[0]  # normalization interval
...
def denormalize(channel, value, normalization_interval=(-1, 1), sigma_factor=1):
    ...
    if normalizing_mask[channel]:
        ...
        denormalized_value = (value - normalization_interval[0]) / (
                    normalization_interval[1] - normalization_interval[0])  # [0,1]
